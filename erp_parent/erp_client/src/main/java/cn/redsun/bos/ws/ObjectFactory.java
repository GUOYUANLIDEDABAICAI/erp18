 ...
 * generated in the cn.redsun.bos.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddResponse_QNAME = new QName("http://ws.bos.redsun.cn/", "addResponse");
    private final static QName _WaybilldetailListResponse_QNAME = new QName("http://ws.bos.redsun.cn/", "waybilldetailListResponse");
    private final static QName _Add_QNAME = new QName("http://ws.bos.redsun.cn/", "add");
    private final static QName _WaybilldetailList_QNAME = new QName("http://ws.bos.redsun.cn/", "waybilldetailList");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.redsun.bos.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.redsun.cn/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.redsun.cn/", name = "waybilldetailListResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.redsun.cn/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.redsun.cn/", name = "waybilldetailList")
